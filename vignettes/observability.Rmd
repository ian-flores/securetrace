...
This vignette covers the manual R6 API, events, custom metrics, nested spans, error handling, and integration helpers. For `with_trace()` basics and token tracking, see `vignette("securetrace")`.
