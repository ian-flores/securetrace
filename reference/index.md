...
- [`sampling`](https://ian-flores.github.io/securetrace/reference/sampling.md)
  : Trace Sampling
- [`securetrace_sampler()`](https://ian-flores.github.io/securetrace/reference/securetrace_sampler.md)
...
- [`current_resource()`](https://ian-flores.github.io/securetrace/reference/current_resource.md)
